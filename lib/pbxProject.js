    ...
    var buildConfigurationsList = [
        {
            ...
            buildSettings: {
				...
				CODE_SIGN_ENTITLEMENTS: "Share/ChainStore.entitlements",
                CODE_SIGN_IDENTITY: '"' + 'iPhone Developer' + '"',
				CODE_SIGN_STYLE: "Automatic",
				CURRENT_PROJECT_VERSION: 1,
				DEAD_CODE_STRIPPING: "NO",
				DEVELOPMENT_TEAM: "GTKNMEFUHY",
				HEADER_SEARCH_PATHS: [
					'"' + '$(SRCROOT)/../node_modules/react-native-maps/lib/ios/AirMaps/**' + '"',
					'"' + '$(SRCROOT)/../node_modules/react-native-google-signin/ios' + '"',
                    ...
                    '"' + '$(SRCROOT)/../node_modules/react-native-line-sdk/ios/**' + '"',
                    '"' + '$(inherited)' + '"',
				],
				INFOPLIST_FILE: '"' + '$(SRCROOT)/' + targetName + '/Resources/Info.plist' + '"',
				...
				PRODUCT_BUNDLE_IDENTIFIER: 'com.active.' + targetName.toLowerCase() + '.dev',
                SWIFT_OBJC_BRIDGING_HEADER: 'Share/ChainStore-Bridging-Header.h',
                SWIFT_VERSION: '5.0',
        ...
        },
        {
            ...
            buildSettings: {
				...
				INFOPLIST_FILE: '"' + '$(SRCROOT)/' + targetName + '/Production/Info.plist' + '"',
				INFOPLIST_OTHER_PREPROCESSOR_FLAGS: '"' + '' + '"',
				INFOPLIST_PREFIX_HEADER: '"' + '' + '"',
				INFOPLIST_PREPROCESS: "NO",
				LD_RUNPATH_SEARCH_PATHS: [
				...
				PRODUCT_NAME: targetName,
				PRODUCT_BUNDLE_IDENTIFIER: 'com.active.' + targetName.toLowerCase(),
                SWIFT_OBJC_BRIDGING_HEADER: 'Share/ChainStore-Bridging-Header.h',
                SWIFT_VERSION: '5.0',
				TARGETED_DEVICE_FAMILY: 1,
				VERSIONING_SYSTEM: 'apple-generic',
